...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    foreach ($carts as $cart){
        $quantity = $_POST['quantity'][$cart['cart_id']];
        cart_update_quantity($cart['cart_id'], $quantity);
    }
      ...
      <div class="row">
        <div class="col-xxl-12">
          <div class="breadcrumb__content p-relative z-index-1">
            <h3 class="breadcrumb__title">Shopping Cart <?=$_SESSION['user']['user_id']?></h3>
                    ...
                    <tr>
                      ...
                      <td class="tp-cart-quantity">
                        <div class="tp-product-quantity mt-10 mb-10">
                          ...
                          <!-- input quantity -->
                          <input class="tp-cart-input" type="text" value="<?= $cart['quantity'] ?>" name="quantity[<?= $cart['cart_id'] ?>]" />
...
?>
>>>>>>> 82f394b47f3b49f38eca6c5426c568ade28cae88
